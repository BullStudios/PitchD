    ...
    <main className="max-w-5xl mx-auto px-4 py-12">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        <div className="relative flex-1 max-w-sm">
          ...
          <input
            ...
            className="w-full pl-8 pr-4 py-2 border border-gray-200 rounded-lg text-sm outline-none focus:border-gray-400 transition-colors"
          />
          {search && (
            <button
              onClick={() => setSearch('')}
      ...
      {filtered.length === 0 ? (
        <div className="text-center py-16">
          <p className="text-gray-400 mb-2">No cities found</p>
